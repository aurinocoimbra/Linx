...
DEFINE CLASS oDbTable AS Custom
    ...
    **
    ** Atualizei em 26/09/2023
    **
    FUNCTION GET_SQL_INSERT_COMMAND( cCursor, lAddAll )
	    ...
	    IF !EMPTY( cSQLCommand ) THEN  
	      ...
	      cSQLCommand = "INSERT INTO "+LOWER(THIS.TableName)+" SET " + cSQLCommand
	    ENDIF  
	    RETURN cSQLCommand
    ENDFUNC
